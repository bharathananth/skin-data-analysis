...
if (!file.exists("visualize/data/results_populationrhy_internaltime_artificial.rds")){
  ...
  saveRDS(results, file = "visualize/data/results_populationrhy_internaltime_artificial.rds")
}  
...
results <- readRDS("visualize/data/results_populationrhy_internaltime_artificial.rds") %>%
...
fig1 %>% ggsave('figures/fig1_artificial.pdf', ., width = 11, height = 11)
