...
ourZZgenes_inWu2020.E <- vGath %>% filter(tissue=="epidermis") %>% filter(Symbol %in% ZZ_Wu2020.E)
ourZZgenes_inWu2020.D <- vGath %>% filter(tissue=="dermis") %>% filter(Symbol %in% ZZ_Wu2020.D) 
