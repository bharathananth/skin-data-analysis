...
%\begin{figure*}[h!tb]
%	\begin{center}
%		\includegraphics[width=\textwidth]{./Figures/suppfig3.pdf}
%		\caption{\textbf{Amplitudes of circadian genes differ across subjects, while magnitudes differ across skin layers. } Quantification of the relative variability in magnitude (MESOR), amplitude and phase across subjects (blue) and layers (red) in rhythmic genes in at least one layer using the coefficient of variation.}%ZeitZeiger in D and E separately with internal time. A) Timeseries of dermal ZZ genes
...
\begin{table}[h!tb]\vspace{-.4cm}
	...
	\begin{tabular}{cccccccc}
		...
		\textbf{\begin{tabular}[c]{@{}c@{}}Min\\Wake up time\\free days\end{tabular}} &
		\textbf{\begin{tabular}[c]{@{}c@{}}Alarm\\free days?\end{tabular}} &
		\textbf{\begin{tabular}[c]{@{}c@{}}Corrected\\mid sleep time\end{tabular}} \\ \hline
